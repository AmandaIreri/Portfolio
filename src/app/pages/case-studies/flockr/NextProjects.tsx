// NextProjects for the FLOCKR case study
// Shows: Pension Platform + Qaribia Tourism
...
export function NextProjects() {
  ...
  return (
    <section ref={ref} style={{ backgroundColor: "#FFFFFF", padding: "72px 0" }}>
      ...
      <style>{`
        .np-f-thumb { transition: transform 0.5s cubic-bezier(0.16,1,0.3,1); }
        a:hover .np-f-thumb { transform: scale(1.04); }
      `}</style>
    </section>
  );
}