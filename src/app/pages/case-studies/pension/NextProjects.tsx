// NextProjects for the PENSION PLATFORM case study
// Shows: Flockr + Qaribia Tourism
...
export function NextProjects() {
  ...
  return (
    <section ref={ref} style={{ backgroundColor: "#FFFFFF", padding: "72px 0" }}>
          ...
          {RELATED.map((project, i) => (
            <Link
              ...
              style={{
                ...
                boxShadow: "0 2px 16px rgba(62,39,35,0.06)",
                opacity: visible ? 1 : 0,
                transform: visible ? "translateY(0)" : "translateY(20px)",
              ...
              onMouseEnter={e => {
                ...
                el.style.boxShadow = "0 8px 32px rgba(62,39,35,0.12)";
                el.style.transform = "translateY(-4px)";
              }}
              onMouseLeave={e => {
                const el = e.currentTarget as HTMLAnchorElement;
                el.style.boxShadow = "0 2px 16px rgba(62,39,35,0.06)";
                el.style.transform = "translateY(0)";
              }}
            >
              {/* Thumbnail — logo vs screen handled separately */}
              <div
                style={{
              ...
              {/* Content */}
              <div style={{ padding: "20px 24px", backgroundColor: "#FDFCFB" }}>
                ...
                <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13, fontWeight: 700, color: "#3E2723", borderBottom: "1.5px solid #D4AF37", paddingBottom: 2 }}>
                  View Case Study →
                </span>
              </div>
            </Link>
      ...
      <style>{`
        .np-p-thumb { transition: transform 0.5s cubic-bezier(0.16,1,0.3,1); }
        a:hover .np-p-thumb { transform: scale(1.04); }
      `}</style>
    </section>
  );
}